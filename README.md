...
- 🔄 **Управление контейнерами** - запуск, остановка, перезапуск (в разработке - Фаза 3)
- 🔄 **Virtual Hosts** - автоматическое создание nginx конфигов (в разработке - Фаза 5)
- 🔄 **SSL/HTTPS** - автоматические сертификаты Let's Encrypt (в разработке - Фаза 6)
- 🔄 **MCP Server** - для интеграции с AI агентами (в разработке - Фаза 8)
...
│   └── docker-compose.yml
│
└── docklite-projects/          # Развернутые проекты
    ├── project1/
    │   ├── docker-compose.yml
    │   └── .env
    └── project2/
