...
class TraefikService:
        ...
        try:
            ...
            if 'ports' in first_service:
                ...
                if ports and len(ports) > 0:
                    ...
                    # Parse "8080:80" or "${PORT}:80" -> extract internal port (after :)
                    if ':' in port_mapping:
    ...
    def inject_labels_to_compose(
        ...
        try:
            ...
            first_service['labels'] = [
                label for label in first_service['labels'] 
            ...
            # Remove 'ports' section to avoid port conflicts (Traefik handles routing)
            if 'ports' in first_service:
            ...
            modified_yaml = yaml.dump(compose_data, default_flow_style=False, sort_keys=False)
