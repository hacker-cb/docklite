...
class DockerService:
    ...
    def start_container(self, container_id: str) -> tuple[bool, Optional[str]]:
        ...
        try:
            ...
            return (
                False,
                e.stderr.strip() or f"Failed to start container '{container_id}'",
            )
        except Exception as e:
    ...
    def stop_container(
        ...
        try:
            ...
            return (
                False,
                e.stderr.strip() or f"Failed to stop container '{container_id}'",
            )
        except Exception as e:
            return False, f"Docker error: {str(e)}"
    ...
    def restart_container(
        ...
        try:
            ...
            return (
                False,
                e.stderr.strip() or f"Failed to restart container '{container_id}'",
            )
        except Exception as e:
            return False, f"Docker error: {str(e)}"
    ...
    def remove_container(
        ...
        try:
            ...
            return (
                False,
                e.stderr.strip() or f"Failed to remove container '{container_id}'",
            )
        except Exception as e:
            return False, f"Docker error: {str(e)}"
